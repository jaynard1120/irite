...
const routes: Routes = [
  ...
  {path: "admin/stories/review", component: StoryValComponent, pathMatch: "full" ,canActivate:[AdminGuard]},
  ...
  {path: "review", component: ReviewComponent, pathMatch:"full", canActivate:[RouteguardGuard]},
